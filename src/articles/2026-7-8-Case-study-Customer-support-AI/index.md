---
path: /customer-support-ai-case-study
date: 2026-07-08
title: Customer Support AI Case Study
author: Oghenero Adaware
description: Customer Support AI Case Study
tags: ["AI", "RAG", "LLM", "Case Study"]
---


# Case Study: PiggyVest Support Triage Agent

Documenting my process of building a firstline support triage agent for PiggyVest that is AI-powered.
I am a fullstack developer who has been building software products for over 9 years now. My main focus has been server and UI (mobile and web) development mostly using Typescript (Node.js, React, React Native).
I have a goal to learn about AI product development, that is what drives me to work on this case study. Also I see this as the next frontier in software development and I want to be a part of it.
